...
class MockLoginUsecase extends _i1.Mock implements _i3.LoginUsecase {
  ...
  @override
  _i4.Future<(_i5.LoginFailure?, bool)> call(_i6.NoParams? noParams) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
          [noParams],
        ),
        returnValue: _i4.Future<(_i5.LoginFailure?, bool)>.value((null, false)),
      ) as _i4.Future<(_i5.LoginFailure?, bool)>);
}
...
class MockGetUserDetailsUsecase extends _i1.Mock
    implements _i7.GetUserDetailsUsecase {
  MockGetUserDetailsUsecase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<(_i8.GetUserDatailsFailure?, _i2.UserDetailsEntity)> call(
          _i6.NoParams? params) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
        ...
        returnValue: _i4
            .Future<(_i8.GetUserDatailsFailure?, _i2.UserDetailsEntity)>.value((
          null,
          _FakeUserDetailsEntity_0(
            this,
            Invocation.method(
      ...
      ) as _i4.Future<(_i8.GetUserDatailsFailure?, _i2.UserDetailsEntity)>);
}

/// A class which mocks [ExistsUserUsecase].
///
/// See the documentation for Mockito's code generation for more information.
class MockExistsUserUsecase extends _i1.Mock implements _i9.ExistsUserUsecase {
  MockExistsUserUsecase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<(_i5.ExistsUserFailure?, bool)> call(_i6.NoParams? noParams) =>
      (super.noSuchMethod(
        Invocation.method(
          #call,
          [noParams],
        ...
        returnValue:
            _i4.Future<(_i5.ExistsUserFailure?, bool)>.value((null, false)),
      ) as _i4.Future<(_i5.ExistsUserFailure?, bool)>);
}

/// A class which mocks [SaveUserUsecase].
///
/// See the documentation for Mockito's code generation for more information.
class MockSaveUserUsecase extends _i1.Mock implements _i10.SaveUserUsecase {
  MockSaveUserUsecase() {
    _i1.throwOnMissingStub(this);
  }

  @override
  _i4.Future<(_i8.SaveUserFailure?, bool)> call(
      ...
      (super.noSuchMethod(
        ...
        returnValue:
            _i4.Future<(_i8.SaveUserFailure?, bool)>.value((null, false)),
      ) as _i4.Future<(_i8.SaveUserFailure?, bool)>);
}
